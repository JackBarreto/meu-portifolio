...
document.addEventListener('DOMContentLoaded', function () {
    ...
    contactForm.addEventListener('submit', function (event) {
        ...
        // Pega o texto digitado nos campos e remove espaços em branco extras
        ...
        if (nome === '' || email === '' || mensagem === '') {
            ...
            return; // Para a execução do código aqui se o campo estiver vazio
        }

        // Usa uma expressão regular (Regex) para verificar se o email tem um formato válido
